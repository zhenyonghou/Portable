...
@protocol BALocationManagerDelegate;
...
@property (nonatomic, weak) id<BALocationManagerDelegate> delegate;
...
@protocol BALocationManagerDelegate <NSObject>

- (void)locationManager:(BALocationManager *)manager didUpdateLocation:(CLLocation*)location;
