...
+ (void)setBarBackgroundWithNormalImage:(UIImage*)normalImage selectedImage:(UIImage*)selectedImage
{
    [[UITabBar appearance] setBackgroundImage:normalImage];
...
{
    [super viewDidLoad];
    [self configViewControllerEdges];
}
