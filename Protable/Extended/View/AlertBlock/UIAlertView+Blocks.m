...
-(id)initWithTitle:(NSString *)inTitle message:(NSString *)inMessage cancelButtonItem:(BAButtonItem *)inCancelButtonItem otherButtonItems:(BAButtonItem *)inOtherButtonItems, ... 
{
