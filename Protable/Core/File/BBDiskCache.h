...
typedef void (^BADiskCacheBlock)(BBDiskCache *cache);
typedef void (^BADiskCacheObjectBlock)(BBDiskCache *cache, NSString *key, id <NSCoding> object, NSURL *fileURL);

@interface BBDiskCache : NSObject
